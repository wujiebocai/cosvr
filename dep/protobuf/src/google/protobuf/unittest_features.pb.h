...
/* @@protoc_insertion_point(class_definition:pb.TestFeatures.MessageFeature) */ {
 public:
  ...
  inline TestFeatures_MessageFeature(TestFeatures_MessageFeature&& from) noexcept
      : TestFeatures_MessageFeature(nullptr, std::move(from)) {}
 ...
 protected:
  ...
  TestFeatures_MessageFeature(::google::protobuf::Arena* arena, TestFeatures_MessageFeature&& from) noexcept
      : TestFeatures_MessageFeature(arena) {
    *this = ::std::move(from);
  }
